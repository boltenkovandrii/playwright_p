...
def test_add_single_product_to_cart(prestashop_home_page):
...
def test_add_multiple_quantities(prestashop_home_page):
    product_name = "Hummingbird printed t-shirt"
...
def test_remove_product_from_cart(prestashop_home_page):
    product_name = "Hummingbird printed t-shirt"
...
def test_update_product_quantity(prestashop_home_page):
    product_name = "Hummingbird printed t-shirt"
...
def test_continue_shopping_from_cart(prestashop_home_page):
    product_name = "Hummingbird printed t-shirt"
...
def test_verify_cart_totals(prestashop_home_page):
    product_name = "Hummingbird printed t-shirt"
